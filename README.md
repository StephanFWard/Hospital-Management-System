...
In this page, doctor can able to see their appointments which has been booked by the patients. Fig 1.12 shows the appointment of the doctor ‘Stephan’ which has been booked by the patient ‘Kenny Sebastian’ (Fig 1.6). This means that the doctor ‘Stephan’ will have an appointment with the patient ‘Kenny Sebastian’ on 10-10-2019 10AM. 
