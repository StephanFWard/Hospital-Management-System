...
### SOFTWARES USED
  ...
  - VSCode was used as a text editor. Version: 1.85.2 (system setup)
  - Google Chrome Version 120.0.6099.225 (Official Build) (64-bit) was used to run the project (localhost/Hospital-Management-System was used as the url).
...
In this page, doctor can able to see their appointments which has been booked by the patients. For example: the appointment of the doctor ‘Stephan’ which has been booked by the patient ‘Kenny Sebastian’. This means that the doctor ‘Stephan’ will have an appointment with the patient ‘Kenny Sebastian’ on 10-10-2019 10AM. 
...
**1. View the list of all patients registered:**
  ...
  &nbsp; &nbsp; &nbsp; Admin can able to view all the patients registered. This includes the patients’ First Name, Last Name, Email ID, Contact Number and Password. Similar to the doctor module, admin can also search for a patient by their contact number in the search box.
...
### 1. Cancel Appointments
  ...
  If the patient deletes the last record (for doctor Stephan), then a label "deleted by you" will be displayed in the column 'Current Status' and the action will change to cancel state.
  
  Now if we login to the doctor Stephan's account and view his appointment details.
